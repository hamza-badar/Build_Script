...
echo "clonning trees"
git clone https://github.com/hamza-badar/device_motorola_otus -b 7.1.1 device/motorola/otus

echo "clonning common trees"
git clone https://github.com/hamza-badar/android_device_motorola_msm8610-common.git -b aex device/motorola/msm8610-common
...
git clone git https://github.com/hamza-badar/proprietary_vendor_qcom_binaries -b cm-14.1 vendor/qcom/binaries
